  ...
  <head>';
	...
	if ($PageID == null)
	{
		...
		while ($Prod_row1 = mysql_fetch_array($Prod_rs1)) {
			...
			{
				echo '<title>' . $Prod_row1["Category"] . ' : Personal Entertainment : Future Bound Enterprises</title>
  ...
  <body>
	...
	<div id="Search"> 
		 ...
		 <div id="YouAreHereList">		 	
			 <form action="">
                  <select onchange="document.location=this.value" name="CatId">';
					if ($PageID == 200)
					{	
                        echo '<option value="index.php?PageID=200" selected="selected">CDs</option>
							  <option value="index.php?PageID=201">DVDs</option>
							  <option value="index.php?PageID=202">Blu-ray Discs</option>';
					}
					else if ($PageID == 201)
					{	
						echo '<option value="index.php?PageID=200">CDs</option>
							  <option value="index.php?PageID=201" selected="selected">DVDs</option>
							  <option value="index.php?PageID=202">Blu-ray Discs</option>';
					}
					else if ($PageID == 202)
					{	
						echo '<option value="index.php?PageID=200">CDs</option>
							  <option value="index.php?PageID=201">DVDs</option>
							  <option value="index.php?PageID=202" selected="selected">Blu-ray Discs</option>';
					}
				  echo '</select>
             </form>
		 </div>
		 ...
		 <div id="YouAreHereLinks">		 
			...
			<a href="index.php?PageID=200">Personal Entertainment</a> &raquo; &nbsp;
