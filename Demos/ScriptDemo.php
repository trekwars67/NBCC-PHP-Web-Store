...
// "Generate HTML at Server Side using PHP"
	...
	while ($intProductNumber++ < 8) {
		...
		echo '
			<hr /><br />
			<img src="images/' . $intProductNumber . '.gif" height=100 width=100 align=left />
			Item #' . $intProductNumber . '<br />
			Category<br />
			Description<br />
		';
		...
		echo '
			...
			option1desc <br />
			<ul>
				<li>option1a</li> <li>option1b</li><li>option1c</li> <li>option1d</li>
			</ul>
		';
		...
		echo '
			...
			option2desc <br />
			<ul>
				<li>option2a</li> <li>option2b</li><li>option2c</li> <li>option2d</li>
			</ul>
		';
...
// "Display Individual Records"
  ...
  while ($Prod_row = mysql_fetch_array($Prod_rs)) {
    ...
    if ($Prod_row["Category"] == "Sportswear") {
	   ...
	   echo '
		  <hr /><br />
		  <img src="images/' 		. $Prod_row["Image"] . '.gif" height=100 width=100 align=left />
		  Item #' 					. $Prod_row["ID"] .  
		  '<br />Price :: ' 		. number_format($Prod_row["Price"], 2, ".", ",") . 
		...
		if ( $Prod_row["Option2Desc"] != "" ) {
		   	echo '
				<br clear=all /><br /> '
				. $Prod_row["Option2Desc"] . ' <br /> 
				<ul>
					<li>option2a</li> <li>option2b</li> <li>option2c</li> <li>option2d</li>
				</ul>
			';
