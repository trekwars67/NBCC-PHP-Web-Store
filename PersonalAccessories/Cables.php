...
<html>
  ...
  <head>
    ...
    <title>
      Cables : Personal Accessories : Future Bound Enterprises
    </title>
	
	<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1"> 
    <meta name="description"  		content="Shop around for trusty cables on this page!" />
		 ...
		 <div id="YouAreHereList">		 	
			 <form action="">
                  <select onchange="document.location=this.value" name="CatId">
                        ...
                        <option value="Cables.php" selected="selected">Cables</option>
                  </select>
             </form>
		 </div>
